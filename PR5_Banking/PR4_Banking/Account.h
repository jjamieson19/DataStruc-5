...
protected:
	...
	*/
	std::string get_fees()
	{
		...
		charge = this->get_customer()->get_charge();
		overdraft = this->get_customer()->get_overdraft();
		std::stringstream ss;
...
protected:
	...
	*/
	void add_interest(double interest) {
		...
		tran = new Transaction(this->get_customer()->get_cust(), "Interest", amt, this->get_fees());
...
public:
	...
	*/
	virtual void deposit(double amt) {
		...
		tran = new Transaction(this->get_customer()->get_cust(), "Deposit", amt, this->get_fees());
		transactions.push_back(tran);
	}
	...
	*/
	virtual void withdraw(double amt) {
		...
		tran = new Transaction(this->get_customer()->get_cust(), "Withdrawl", amt, this->get_fees());
		transactions.push_back(tran);
	}
